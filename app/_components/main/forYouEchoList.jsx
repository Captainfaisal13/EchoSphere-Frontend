  ...
  try {
    const data = await fetch("http://localhost:3000/api/v1/tweet/", {
      ...
      headers: {
        ...
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NWZhZGQ0MWEwOGI2NjQ4ZDhjOGFlYWQiLCJuYW1lIjoiU2hhaWtoIEZhaXNhbCIsImlhdCI6MTcxMzY0MzQ1MCwiZXhwIjoxNzE2MjM1NDUwfQ.hIu-iZdaBxqonI2j1OnLl4VJYxFuIQhCT3XZ4zOfXec",
      },
    });
